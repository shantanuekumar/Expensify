...
const expenseOne = store.dispatch(addExpense({description: 'Rent',amount: 10,createdAt: -200}));
const expenseTwo = store.dispatch(addExpense({description: 'coffee', amount: 15,createdAt: 1200}));
...
const demoState = {
    expenses: [{
        ...
        note: 'This was the final payment for this option',
        amount: 54500,
        createdAt: 0
    }],
    filters: {
